  ...
  useEffect(() => {
    const loadVehicles = async () => {
      try {
        ...
        setVehicles([
            { id: 1, name: "Roda E-Bike Sport", type: VehicleType.EBIKE, price: 3500000, brand: "Roda", image_url: "https://images.unsplash.com/photo-1571068316344-75bc76f778f7?auto=format&fit=crop&q=80&w=600", description: "Ideal para la ciudad" },
            { id: 2, name: "Scooter Pro Max", type: VehicleType.SCOOTER, price: 1800000, brand: "Segway", image_url: "https://images.unsplash.com/photo-1558981806-ec527fa84a3c?auto=format&fit=crop&q=80&w=600", description: "Portabilidad máxima" },
            { id: 3, name: "Moped Eléctrico 3000", type: VehicleType.MOPED, price: 7500000, brand: "NIU", image_url: "https://images.unsplash.com/photo-1558981403-c5f9899a28bc?auto=format&fit=crop&q=80&w=600", description: "Potencia y autonomía" },
        ])
      } finally {
        setLoading(false)
      }
      ...
      <main className="pt-32 pb-20 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {vehicles.map((vehicle) => (
            <div key={vehicle.id} className="bg-white/5 border border-white/10 rounded-2xl overflow-hidden hover:border-roda-green/50 transition-all group">
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between mt-auto">
                    ...
                    <button 
                        ...
                        className="bg-roda-green text-dark-bg px-4 py-2 rounded-lg font-bold text-sm hover:bg-[#b8e000] transition-colors"
                    >
                        Simular Crédito
                    </button>
                </div>
