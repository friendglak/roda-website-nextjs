  ...
  constructor(options: any) {
    ...
    super("AsciiEffect", fragmentShader, {
      ...
      uniforms: new Map([
        ...
        ["jitterSpeed", new Uniform(postfx.jitterSpeed || 5)],
        ...
        ["noiseScale", new Uniform(postfx.noiseScale || 2)],
        ...
        ["glitchFrequency", new Uniform(postfx.glitchFrequency || 2)],
...
export const AsciiEffect = forwardRef((props: any, ref: any) => {
  ...
  const styleMap: { [key: string]: number } = { standard: 0, dense: 1, minimal: 2, blocks: 3 }
